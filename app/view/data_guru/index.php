        ...
        <button style="margin-bottom:20px; background-color: #071952; color: white;" type="button" class="btn border" data-bs-toggle="modal" data-bs-target="#exampleModal"
          ...
          <tr style="margin-bottom: 50px">
                ...
                <td class="col-3" style="text-align:center;background-color:#071952;">
                        <a style="margin-left:5px;" href="<?= BASE_URL; ?>/data_guru/hapus/<?= $data_guru['id']; ?>" class="btn btn-danger" onclick="return confirm('yakin?');">hapus</a>
                        <a style="margin-left:5px;" href="<?= BASE_URL; ?>/data_guru/detail/<?= $data_guru['id']; ?>" class="btn btn-primary">Baca</a>
                        <a style="margin-left:5px;" href="<?= BASE_URL; ?>/data_guru/ubah/<?= $data_guru['id']; ?>" class="btn btn-success tampilModalUbah1" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="<?=$data_guru['id'];?>">ubah</a>
                    <?php endforeach;?>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 style="color: black" class="modal-title fs-5" id="exampleModalLabel">Tambah Data Guru</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <form action="<?= LINK_URL; ?>/data_guru/tambah" method="POST">
